...
import { getCenterTemplate, getCenterTemplateWithStatus, postTemplate } from '../../../apis/api/Template';
...
const Template = () => {
    ...
    useEffect(() => {
        getCenterTemplateWithStatus(authToken.current, pCenterId)
            .then(data => {
                console.log(data);
                setTemplates(data);
            })
    ...
    return (
        <div>
                        ...
                        <div className="content-container">
                            <div className="title-wrap" style={{ display: "flex" }}>
                                <div style={{ width: "50%", textAlign: "left" }}>
                                    <label className="label-title">정규 수업 관리</label>
                                </div>
                                <div style={{ width: "50%", textAlign: "right" }}>
                                    <Button variant="outline-primary" onClick={handleTemplateRegisterModalState}>
                                        정규 수업 추가하기
                                    </Button>
                                </div>
                            </div>
            ...
            <TemplateRegisterModal
                ...
                modalVisible={templateRegisterModalState}
                handleCloseModal={handleTemplateRegisterModalState}
            />
        </div >
    );
}
